...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Canadas Family Grocery Store  Sobeys Inc/a_Scene Grocery Offers_inline-flex items-ce_e62633'), 
    20)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Subscription - Sobeys Inc/span_Sign up for emails_gigya-label-text'), 15)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Subscription - Sobeys Inc/span_Sign up for emails_gigya-label-text'), 
    15)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Subscription - Sobeys Inc/span__gigya-label-text'), 10)
