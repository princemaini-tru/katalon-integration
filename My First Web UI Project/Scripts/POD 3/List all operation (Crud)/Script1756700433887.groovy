...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Canadas Family Grocery Store  Sobeys Inc/span_Account_icon-list max-w-full w-auto mo_32d592'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Canadas Family Grocery Store  Sobeys Inc/button_Choose an option_inline-flex items-c_be2b09'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/button_Your Privacy dialog closed_text-xs u_27ab04'), 
    10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/span_Manage List_font-bold text-brandSecond_50b6fe'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/a_Your Privacy dialog closed_text-body text_61309a'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/button_Name your shopping list_inline-flex _bbfd2f'), 
    10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/span_Add New List_icon-dots text-brandSecon_3fc693'), 
    10)

WebUI.click(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/span_Add New List_icon-dots text-brandSecon_3fc693'))

WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/button_Delete_items-center justify-center t_811c2c'), 
    10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/button_Rename_items-center justify-center t_aca9d9'), 
    10)
...
WebUI.click(findTestObject('Object Repository/Page_Organize  Update Your Grocery List Onl_7d1a16/button_Cancel_inline-flex items-center just_884d91'))
