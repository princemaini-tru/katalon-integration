...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Canadas Family Grocery Store  Sobeys Inc/a_Recipes  More_menu-link menu-link-level-3'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Easy Food  Beverage Recipes  Sobeys Inc/button_Your Privacy dialog closed_text-xs u_27ab04'), 
    15)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Easy Food  Beverage Recipes  Sobeys Inc/span_Add to Meal Plan_flex justify-end item_bb69e1'), 
    15)

WebUI.click(findTestObject('Object Repository/Page_Easy Food  Beverage Recipes  Sobeys Inc/span_Add to Meal Plan_flex justify-end item_bb69e1'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Easy Food  Beverage Recipes  Sobeys Inc/p'), 15)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Easy Food  Beverage Recipes  Sobeys Inc/p'), 'Log in now to:')
